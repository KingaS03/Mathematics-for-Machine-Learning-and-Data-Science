...
def run_quiz(questions):
    for question in questions:
        ...
        if answer == question.answer:
            print(f'Correct answer. Well done!\n')
        else:
